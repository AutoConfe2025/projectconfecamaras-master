...
public class SubirArchivoDoc implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        try {
            setClipboardData(FileUpload.subirArchivo().archivoDoc());
    ...
    public static SubirArchivoDoc enConfecamaraSII(){
        return instrumented(SubirArchivoDoc.class);
    }
}