...
public class ExpedientesPalabras {


    public static final String NOMBRE_RAZON_SOCIAL_PALABRA = "(AAPRO) ACADEMIA AUTOMOVILISTICA LOS PROFESIONALES";
    ...
    public static final String NOMBRE_ACTIVIDAD2 = "P8559";
