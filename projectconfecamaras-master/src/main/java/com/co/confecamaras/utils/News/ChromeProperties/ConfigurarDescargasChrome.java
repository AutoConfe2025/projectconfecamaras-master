package com.co.confecamaras.utils.News.ChromeProperties;
...
public class ConfigurarDescargasChrome {
    ...
    public static WebDriver configurarDriver(String download_path) {
