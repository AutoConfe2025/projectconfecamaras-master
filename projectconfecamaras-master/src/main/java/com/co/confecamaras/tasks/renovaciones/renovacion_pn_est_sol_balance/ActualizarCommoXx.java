...
public class ActualizarCommoXx implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                Scroll.to(PARAMETRO_SOL_BALANCE_CAJEROS_TODAS).andAlignToBottom(),
                SelectFromOptions.byValue("S-PNAT").from(PARAMETRO_SOL_BALANCE_CAJEROS_TODAS),
    ...
    public static ActualizarCommoXx ActualizaCierra(){
        return instrumented(ActualizarCommoXx.class);
    }
}
