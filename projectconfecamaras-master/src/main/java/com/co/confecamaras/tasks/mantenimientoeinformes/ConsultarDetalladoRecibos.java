...
import static com.co.confecamaras.utils.mantenimientoeinformes.DetalladoRecibosReversadoConstants.BUSQUEDA_DETALLADO_RECIBO_REVERSADO;

public class ConsultarDetalladoRecibos implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(BUSQUEDA_DETALLADO_RECIBO_REVERSADO).into(TXT_BUSQUEDA_INPUT),
    ...
    public static ConsultarDetalladoRecibos reversados(){
        return Tasks.instrumented(ConsultarDetalladoRecibos.class);
    }
}
