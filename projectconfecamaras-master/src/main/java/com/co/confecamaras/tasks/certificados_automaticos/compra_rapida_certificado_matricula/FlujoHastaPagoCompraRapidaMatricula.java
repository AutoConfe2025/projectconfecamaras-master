package com.co.confecamaras.tasks.certificados_automaticos.compra_rapida_certificado_matricula;
...
@AllArgsConstructor
public class FlujoHastaPagoCompraRapidaMatricula implements Task {
    ...
    public static FlujoHastaPagoCompraRapidaMatricula FlujoRapidoMAtricula(String Expediente){
        return instrumented(FlujoHastaPagoCompraRapidaMatricula.class, Expediente);
    }
}
