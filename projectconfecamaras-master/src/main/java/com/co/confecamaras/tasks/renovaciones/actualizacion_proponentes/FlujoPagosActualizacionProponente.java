...
public class FlujoPagosActualizacionProponente implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                WaitUntil.the(BOTON_RECIBIR_PAGO_ACTUALIZAR_PROPONENTE, isPresent()).forNoMoreThan(120).seconds(),
                Click.on(BOTON_RECIBIR_PAGO_ACTUALIZAR_PROPONENTE),
    ...
    public static FlujoPagosActualizacionProponente FlujoPagosActualizar() {
        return instrumented(FlujoPagosActualizacionProponente.class);
    }
}
