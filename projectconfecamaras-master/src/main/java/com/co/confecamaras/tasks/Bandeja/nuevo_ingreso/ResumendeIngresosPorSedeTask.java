...
public class ResumendeIngresosPorSedeTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Enter.theValue("2025-12-01").into(CAMPO_FECHA_FIN),
                WaitSeconds.seconds(2),
        ...
        actor.attemptsTo(
                ...
                LogEvent.recordevent(Reportes.PASSED, "Finalizo correctamnete Resumende Ingresos Por Sede")
        );
    ...
    public static ResumendeIngresosPorSedeTask estadisticasYextracciones() {
        return new ResumendeIngresosPorSedeTask();
    }
}