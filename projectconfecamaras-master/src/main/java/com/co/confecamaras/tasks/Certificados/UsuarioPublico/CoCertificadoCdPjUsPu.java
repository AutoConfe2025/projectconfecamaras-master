...
import static com.co.confecamaras.userinterfaces.Certificados.UsuarioPublico.CoCertificadoCdPjUsPu.*;


public class CoCertificadoCdPjUsPu implements Task {

    public final Map<String, String> data;

    public CoCertificadoCdPjUsPu(Map<String, String> data) {
        this.data = data;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Scroll.to(BTN_OPERACION_REG_MERCANTIL_PJ),
    ...
    public static CoCertificadoCdPjUsPu coCertificadoCdPjUsPu(Map<String, String> data) {
        return Tasks.instrumented(CoCertificadoCdPjUsPu.class, data);
    }
}
