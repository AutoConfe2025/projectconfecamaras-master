...
import static com.co.confecamaras.userinterfaces.Certificados.UsuarioPublico.CoCertificadoCaPjUsPu.*;

public class CoCertificadoCaPjUsPu implements Task {

    public final Map<String, String> data;

    public CoCertificadoCaPjUsPu(Map<String, String> data) {
        this.data = data;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitInteractions.untilBeEnable(BTN_ACCIONES_PJ),
                Click.on(BTN_ACCIONES_PJ),
                WaitInteractions.untilBeEnable(BTN_OPCION_MERCANTIL_PJ),
                Click.on(BTN_OPCION_MERCANTIL_PJ),
    ...
    public static CoCertificadoCaPjUsPu coCertificadoCaPjUsPu(Map<String, String> data) {
        return Tasks.instrumented(CoCertificadoCaPjUsPu.class, data);
    }
}
