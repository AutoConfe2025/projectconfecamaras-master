...
public class RelacionDeConsultasBiometricasTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                LogEvent.recordevent(Reportes.PASSED, "Finalizo correctamnete Relacion De Consultas Biometricas")
        );
    ...
    public static RelacionDeConsultasBiometricasTask estadisticasYextracciones() {
        return new RelacionDeConsultasBiometricasTask();
    }
}