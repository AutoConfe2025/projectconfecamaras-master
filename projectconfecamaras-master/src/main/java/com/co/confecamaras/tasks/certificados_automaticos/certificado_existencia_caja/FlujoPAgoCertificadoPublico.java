...
import static com.co.confecamaras.userinterfaces.certificados_automaticos.AutomaticoExistenciaCajaPage.BOTON_DESCARGAR_RECIBO_GENERADO;
...
public class FlujoPAgoCertificadoPublico implements Task {
    @Override
...
//                        Log.message("Boton PSE"),
    ...
    public static FlujoPAgoCertificadoPublico FlujoPagoPublicoCertificado(){
        return instrumented(FlujoPAgoCertificadoPublico.class);
    }
}
