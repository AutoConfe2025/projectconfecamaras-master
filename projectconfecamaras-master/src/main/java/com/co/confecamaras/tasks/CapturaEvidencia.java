...
import com.co.confecamaras.interactions.FormularioCapturaEvidencia;
...
public class CapturaEvidencia implements Task {
    ...
    public CapturaEvidencia(String idNombreClienteRazonSocial, String idPrimerNombre, String idSegundoNombre,
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                FormularioCapturaEvidencia.enConfecamaraSII(TXT_NOMBRE_CLIENTE_RAZON_SOCIAL_CAPTURAR_EVIDENCIA, idNombreClienteRazonSocial, TXT_PRIMER_NOMBRE_CAPTURAR_EVIDENCIA,
    ...
    public static CapturaEvidencia enConfecamaraSII(String idNombreClienteRazonSocial, String idPrimerNombre, String idSegundoNombre,
                                                    String idPrimerApellido, String idSegundoApellido, String idDireccionComercial,
                                                    String idMunicipioComercial, String idCodigoPostal, String idTelefono, String idCelular,
                                                    String idEmail, String idConfirmacionEmail, String idFechaExpedicion){
        return instrumented(CapturaEvidencia.class, idNombreClienteRazonSocial, idPrimerNombre, idSegundoNombre, idPrimerApellido,
