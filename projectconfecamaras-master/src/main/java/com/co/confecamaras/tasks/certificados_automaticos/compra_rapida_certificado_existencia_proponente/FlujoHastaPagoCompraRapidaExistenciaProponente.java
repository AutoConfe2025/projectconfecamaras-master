package com.co.confecamaras.tasks.certificados_automaticos.compra_rapida_certificado_existencia_proponente;
...
@AllArgsConstructor
public class FlujoHastaPagoCompraRapidaExistenciaProponente implements Task {

    private final String Expediente;
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                WaitUntil.the(BOTON_PROPONENTE_COMPRA_RAPIDA_CERTIFICADO, isPresent()).forNoMoreThan(10).seconds(),
                Click.on(BOTON_PROPONENTE_COMPRA_RAPIDA_CERTIFICADO),
                ...
                Click.on(BOTON_AÑADIR_CUARTA_CARD_SELECCION),
                Click.on(BOTON_AÑADIR_SEGUNDA_CARD_SELECCION),
    ...
    public static FlujoHastaPagoCompraRapidaExistenciaProponente FlujoRapidaProponente (String Expediente){
        return instrumented(FlujoHastaPagoCompraRapidaExistenciaProponente.class, Expediente);
    }
}
