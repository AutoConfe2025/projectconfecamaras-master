...
import static com.co.confecamaras.userinterfaces.EstadisticasYExtracciones.DetalladoDePagosPorSIIPage.LINK_DESCARGAR_ARCHIVO;


public class RelaciondeUsuariosVerificadosTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                Click.on(LINK_DESCARGAR_ARCHIVO),
                ...
                LogEvent.recordevent(Reportes.PASSED, "Finalizo correctamnete Relacion de Usuarios Verificados")
        );
    ...
    public static RelaciondeUsuariosVerificadosTask estadisticasYextracciones() {
        return new RelaciondeUsuariosVerificadosTask();
    }
}