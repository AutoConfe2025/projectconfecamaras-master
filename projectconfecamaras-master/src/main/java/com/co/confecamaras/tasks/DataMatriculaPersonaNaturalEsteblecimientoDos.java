...
public class DataMatriculaPersonaNaturalEsteblecimientoDos implements Task {
    ...
    public DataMatriculaPersonaNaturalEsteblecimientoDos(String selectConsultaPor, String idNombre,
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(BTN_X_MPNE),
                Scroll.to(BTN_MATRICULA_MPNE).andAlignToBottom(),
                JavaScriptClick.on(BTN_MATRICULA_MPNE),
                JavaScriptClick.on(BTN_MATRICULA_MPNE),
    ...
    public static DataMatriculaPersonaNaturalEsteblecimientoDos enConfecamaraSII(String selectConsultaPor, String idNombre,
                                                                                 String selectEstadoMatriculaRegistro, String idFechaCancelacion,
                                                                                 String selectMotivoCancelacion) {
        return  instrumented(DataMatriculaPersonaNaturalEsteblecimientoDos.class, selectConsultaPor, idNombre,
