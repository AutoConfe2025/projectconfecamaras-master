...
public class ComparativoRenovacionesTask implements Task {
    ...
    public static ComparativoRenovacionesTask estadisticasYextracciones() {
        return new ComparativoRenovacionesTask();
    }
}