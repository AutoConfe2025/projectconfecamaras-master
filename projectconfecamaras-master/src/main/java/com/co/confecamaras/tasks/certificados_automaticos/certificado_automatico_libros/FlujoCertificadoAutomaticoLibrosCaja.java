package com.co.confecamaras.tasks.certificados_automaticos.certificado_automatico_libros;
...
@AllArgsConstructor
public class FlujoCertificadoAutomaticoLibrosCaja implements Task {
    ...
    public static FlujoCertificadoAutomaticoLibrosCaja CertiLibros(String Expediente) {
        return instrumented(FlujoCertificadoAutomaticoLibrosCaja.class, Expediente);
    }
}
