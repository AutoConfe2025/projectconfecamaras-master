...
import static com.co.confecamaras.userinterfaces.Certificados.UsuarioPublico.CoCertificadoCaPnUsPu.*;

public class CoCertificadoCaPnUsPu implements Task {
    public final Map<String, String> data;

    public CoCertificadoCaPnUsPu(Map<String, String> data) {
        this.data = data;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitInterrupted2Segundos.esperaConstante2(),
                Scroll.to(BTN_CONTINUAR_CONSULTA_CA).andAlignToBottom(),
                Click.on(BTN_CONTINUAR_CONSULTA_CA),
                WaitInteractions.untilBeEnable(BTN_ACCIONES_PN),
                Click.on(BTN_ACCIONES_PN),
                WaitInteractions.untilBeEnable(BTN_OPCION_MERCANTIL_PN),
                Click.on(BTN_OPCION_MERCANTIL_PN),
    ...
    public static CoCertificadoCaPnUsPu coCertificadoCaPnUsPu(Map<String, String> data) {
        return Tasks.instrumented(CoCertificadoCaPnUsPu.class, data);
    }
}
