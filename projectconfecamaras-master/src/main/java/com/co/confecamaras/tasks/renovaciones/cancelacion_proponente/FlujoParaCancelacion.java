...
import static com.co.confecamaras.userinterfaces.renovaciones.FlujoActualizarProponentePage.BOTON_TRAMITES_REGISTRO_PROPONENTE;
import static com.co.confecamaras.userinterfaces.renovaciones.FlujoCancelacionProponentePage.*;
import static net.serenitybdd.screenplay.Tasks.instrumented;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.isPresent;

public class FlujoParaCancelacion implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(BOTON_SOLICITUD_CANCELACION_PROPONENTE, isPresent()).forNoMoreThan(120).seconds(),
                Click.on(BOTON_SOLICITUD_CANCELACION_PROPONENTE),
    ...
    public static FlujoParaCancelacion FlujoCancelaIngreso(){
        return instrumented(FlujoParaCancelacion.class);
    }
}
