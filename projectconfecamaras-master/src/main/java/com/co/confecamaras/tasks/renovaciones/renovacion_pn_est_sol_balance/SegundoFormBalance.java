...
public class SegundoFormBalance implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(BOTON_RECIBIR_PAGO_1, isPresent()).forNoMoreThan(40).seconds(),
    ...
    public static SegundoFormBalance segunfoForm() {
        return instrumented(SegundoFormBalance.class);
    }
}
