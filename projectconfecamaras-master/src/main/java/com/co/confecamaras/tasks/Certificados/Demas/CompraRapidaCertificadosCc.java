...
import static com.co.confecamaras.userinterfaces.Certificados.Demas.CompraRapidaCertificadosCc.*;


public class CompraRapidaCertificadosCc implements Task {

    public final Map<String, String> data;

    public CompraRapidaCertificadosCc(Map<String, String> data) {
        this.data = data;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(data.get("Identificacion")).into(CUADRO_TEXTO_MATRICULA),
                ...
                WaitInteractions.untilBeEnable(BTN_OK_VENTANA_INFORMACION),
    ...
    public static CompraRapidaCertificadosCc compraRapidaCertificadosCc(Map<String, String> data) {
        return Tasks.instrumented(CompraRapidaCertificadosCc.class, data);
    }
}
