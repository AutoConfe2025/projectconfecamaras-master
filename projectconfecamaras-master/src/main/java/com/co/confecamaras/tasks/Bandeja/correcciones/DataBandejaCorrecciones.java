...
public class DataBandejaCorrecciones implements Task {
    ...
    public static DataBandejaCorrecciones CrearDataCorrecciones(){
        return instrumented(DataBandejaCorrecciones.class);
    }
}
