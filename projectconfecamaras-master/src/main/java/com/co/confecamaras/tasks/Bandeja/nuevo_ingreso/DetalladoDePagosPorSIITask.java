...
import static com.co.confecamaras.userinterfaces.EstadisticasYExtracciones.DetalladoDePagosPorSIIPage.*;


public class DetalladoDePagosPorSIITask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Enter.theValue("2025-12-31").into(CAMPO_FECHA_FIN),
                WaitSeconds.seconds(2),
        ...
        actor.attemptsTo(
                ...
                LogEvent.recordevent(Reportes.PASSED, "Finalizo correctamnete Detallado de Pagos por SII")
        );
    ...
    public static DetalladoDePagosPorSIITask estadisticasYextracciones() {
        return new DetalladoDePagosPorSIITask();
    }
}