package com.co.confecamaras.tasks.renovaciones.actividad_no_comercial_comercial;
...
public class FlujoActividadNoComercial implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        String matricula = actor.recall("matriculaActividadNoComercial");
    ...
    public static FlujoActividadNoComercial FlujoNoComercial(){
        return instrumented(FlujoActividadNoComercial.class);
    }
}
