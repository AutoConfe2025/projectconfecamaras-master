...
public class RunDataBaseQueryRenovacionMatriculaActividadNoComercial implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {

        QueryConfecamarasRenovacionMatriculaActividadNoComercial queryDatabase = new QueryConfecamarasRenovacionMatriculaActividadNoComercial();
        ...
        DataBase.setNumeroMatriculaActividadNoComercial(numMatricula);
    }

    public static RunDataBaseQueryRenovacionMatriculaActividadNoComercial query() {
        return instrumented(RunDataBaseQueryRenovacionMatriculaActividadNoComercial.class);
    }
}