...
public class FormularioUnoNoComercialComercial implements Task {
    @Override
    ...
    public static FormularioUnoNoComercialComercial formularioComercialNoComercial(){
        return instrumented(FormularioUnoNoComercialComercial.class);
    }
}
