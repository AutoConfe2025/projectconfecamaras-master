...
public class DesbloquearLiquidacionFirmadoElectronico implements Task {

    private String idNumeroRecuperacion;

    public DesbloquearLiquidacionFirmadoElectronico(String idNumeroRecuperacion) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitInteractions.untilAppears(BTN_DESBLOQUEAR_LIQUIDACION_FIRMADO_ELECTRONICO),
                Scroll.to(BTN_DESBLOQUEAR_LIQUIDACION_FIRMADO_ELECTRONICO).andAlignToBottom(),
                JavaScriptClick.on(BTN_DESBLOQUEAR_LIQUIDACION_FIRMADO_ELECTRONICO),
                ...
                JavaScriptClick.on(BTN_DESBLOQUEAR_LIQUIDACION)
        );
    }

    public static DesbloquearLiquidacionFirmadoElectronico enConfecamaraSII(String idNumeroRecuperacion) {
        return instrumented(DesbloquearLiquidacionFirmadoElectronico.class, idNumeroRecuperacion);
    }
}