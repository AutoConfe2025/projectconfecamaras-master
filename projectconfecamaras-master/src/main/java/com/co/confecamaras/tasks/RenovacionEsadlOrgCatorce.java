...
public class RenovacionEsadlOrgCatorce implements Task {
    ...
    public RenovacionEsadlOrgCatorce(String selectConsultaPor, String idMatricula, String idNuevosActivos,
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitInteractions.untilAppears(MENU_DES_REQUIERE_VIGILANCI_CONTROL),
                Scroll.to(MENU_DES_REQUIERE_VIGILANCI_CONTROL).andAlignToBottom(),
                SelectFromOptions.byVisibleText("NO").from(MENU_DES_REQUIERE_VIGILANCI_CONTROL),
                WaitInteractions.untilAppears(MENU_DES_REQUIERE_AUTORIZACION),
                SelectFromOptions.byVisibleText("NO").from(MENU_DES_REQUIERE_AUTORIZACION),
                WaitInteractions.untilAppears(MENU_DES_NATURALEZA),
                Scroll.to(MENU_DES_NATURALEZA).andAlignToBottom(),
                SelectFromOptions.byVisibleText("4 - ECONOMIA SOLIDARIA").from(MENU_DES_NATURALEZA),
                WaitInteractions.untilAppears(MENU_DES_CLASE_IDENTIDAD),
                Scroll.to(MENU_DES_CLASE_IDENTIDAD).andAlignToBottom(),
                SelectFromOptions.byVisibleText("COOPERATIVAS").from(MENU_DES_CLASE_IDENTIDAD),
                WaitInteractions.untilAppears(MENU_DES_CLASE_INDICADORES_GESTION),
                Scroll.to(MENU_DES_CLASE_INDICADORES_GESTION).andAlignToBottom(),
                SelectFromOptions.byVisibleText("NO").from(MENU_DES_CLASE_INDICADORES_GESTION),
    ...
    public static RenovacionEsadlOrgCatorce enConfecamaraSII(String selectConsultaPor, String idMatricula, String idNuevosActivos, String idNumerosEmpleados, String selectEsEmprendimientoSocial,
                                                             String selectAutorizaMensajesCorreo, String idActivoCorriente, String idPatrimonioNeto,
                                                             String idIngresosActividadOrdinaria, String idCorreo, String idCelular,
                                                             String selectTipoIdentificacion, String idIdentificacion, String idEmailConfirmacion){
        return instrumented(RenovacionEsadlOrgCatorce.class, selectConsultaPor, idMatricula, idNuevosActivos,
