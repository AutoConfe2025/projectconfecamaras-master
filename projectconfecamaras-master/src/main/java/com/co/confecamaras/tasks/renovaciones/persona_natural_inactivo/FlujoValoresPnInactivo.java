package com.co.confecamaras.tasks.renovaciones.persona_natural_inactivo;
...
import static com.co.confecamaras.userinterfaces.renovaciones.GeneralPage.CAMPO_NUEVO_VALOR_PERSONA_4;
import static net.serenitybdd.screenplay.Tasks.instrumented;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.isPresent;

public class FlujoValoresPnInactivo implements Task {
    @Override
    ...
    public static FlujoValoresPnInactivo ValoresPnInactiva(){
        return instrumented(FlujoValoresPnInactivo.class);
    }
}
