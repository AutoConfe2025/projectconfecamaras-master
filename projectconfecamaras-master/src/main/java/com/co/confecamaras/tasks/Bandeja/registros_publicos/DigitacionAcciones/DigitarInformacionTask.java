    ...
    public <T extends Actor> void performAs(T actor) {
        if(actor.asksFor(ElementoElegible.para(DigitacionPage.LINK_DIG_FORMULARIO))){
            actor.attemptsTo(
                    ...
                    Log.message("EXTINCION DE DOMINIO"),
                    ...
                    Log.message("EMPRENDIMIENTO SOCIAL"),
                    ...
                    Log.message("DATOS PARA NOTIFICACION JUDICIAL"),
                    Scroll.to(DigitacionPage.SLC_NJ_MUNICIPIO),
                    Log.message("SLC_NJ_MUNICIPIO"),
                    ...
                    // ACTIVIDAD ECONOMICA
                    Log.message("ACTIVIDAD ECONOMICA"),
