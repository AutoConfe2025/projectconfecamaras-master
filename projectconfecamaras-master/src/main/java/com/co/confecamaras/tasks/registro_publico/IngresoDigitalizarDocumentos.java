...
@AllArgsConstructor
public class IngresoDigitalizarDocumentos implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                SendKeys.of(Keys.TAB).into(CAMPO_BUSQUEDA_COD_BARRAS_INICIAL)
        );
    }

    public static IngresoDigitalizarDocumentos DigitalizarIngreso(String codigoBarras, String estadoFinal, String bandeja){
        return new IngresoDigitalizarDocumentos(codigoBarras, estadoFinal, bandeja);
    }
}
