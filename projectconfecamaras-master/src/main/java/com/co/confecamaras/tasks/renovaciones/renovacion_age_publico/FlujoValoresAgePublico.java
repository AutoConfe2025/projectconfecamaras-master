package com.co.confecamaras.tasks.renovaciones.renovacion_age_publico;
...
public class FlujoValoresAgePublico implements Task {
    @Override
    ...
    public static FlujoValoresAgePublico formularioAgePublico(){
        return new FlujoValoresAgePublico();
    }
}
