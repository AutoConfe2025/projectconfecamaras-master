package com.co.confecamaras.tasks.certificados_automaticos.compra_rapida_certificado_proponente;
...
@AllArgsConstructor
public class FlujoHastaPagoCompraRapidaProponente implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitUntil.the(BOTON_AÑADIR_CUARTA_CARD_SELECCION, isPresent()).forNoMoreThan(120).seconds(),
    ...
    public static FlujoHastaPagoCompraRapidaProponente flujoRapidoProponente(String Expediente){
        return instrumented(FlujoHastaPagoCompraRapidaProponente.class,Expediente);
    }
}
