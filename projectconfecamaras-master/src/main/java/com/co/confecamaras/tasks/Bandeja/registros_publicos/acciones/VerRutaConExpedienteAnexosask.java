...
import static com.co.confecamaras.userinterfaces.Bandejas.registros_publicos.AccionesPage.AccionesPage.TABLA_ANEXOS;

public class VerRutaConExpedienteAnexosask implements Task {
    private String accion;
    private String codigo_barras;

    public VerRutaConExpedienteAnexosask(String accion, String codigo_barras) {
        this.accion = accion;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                Scroll.to(AccionesPage.ENLACE_VER_EXPEDINETE),
                Click.on(AccionesPage.ENLACE_VER_EXPEDINETE),
                Click.on(AccionesPage.LINK_REGRESAR),
                WaitInteractions.untilAppears(TABLA_ANEXOS),
    ...
    public static VerRutaConExpedienteAnexosask verRuta(String accion, String codigo_barras) {
        return new VerRutaConExpedienteAnexosask(accion, codigo_barras);
    }
}
