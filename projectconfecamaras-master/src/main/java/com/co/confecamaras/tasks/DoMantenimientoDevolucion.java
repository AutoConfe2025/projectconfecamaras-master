...
public class DoMantenimientoDevolucion implements Task {

    private final String descripcion;
    private final String modf = "1";

    public DoMantenimientoDevolucion(String descripcion) {
        this.descripcion = descripcion;
    }

    public static Performable devolucion(String descripcion){
        return instrumented(DoMantenimientoDevolucion.class,descripcion);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue("Maestro Tipo Tram/Devolucion").into(MenuSistema.BUSQUEDA_INPUT),
