...
@AllArgsConstructor
public class FlujoHastaValoresSinEstablecimiento implements Task {
    ...
    public static FlujoHastaValoresSinEstablecimiento FlujoSinEstablecimiento(String valor) {
        return new FlujoHastaValoresSinEstablecimiento(valor);
    }
}
