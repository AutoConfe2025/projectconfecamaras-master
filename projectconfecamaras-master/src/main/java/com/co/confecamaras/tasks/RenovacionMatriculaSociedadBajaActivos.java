...
public class RenovacionMatriculaSociedadBajaActivos implements Task {
    ...
    public RenovacionMatriculaSociedadBajaActivos(String selectConsultaPor, String idMatricula, String idNuevosActivos,
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitInteractions.untilAppears(NUM_CARGOS_DIRECTIVOS_TXT),
                Enter.theValue("1").into(NUM_CARGOS_DIRECTIVOS_TXT),
    ...
    public static RenovacionMatriculaSociedadBajaActivos enConfecamarasSII(String selectConsultaPor, String idMatricula, String idNuevosActivos,
                                                                           String idNuevosActivosDos, String idNroEmpleados, String selectEsEmprendimientoSocial,
                                                                           String selectAutorizaMensajesCorreo, String idActivoCorriente, String idPatrimonioNeto,
                                                                           String idIngresosActividadOrdinaria, String selectTipoIdentificacion,
                                                                           String idIdentificacion, String idEmailConfirmacion) {
        return Tasks.instrumented(RenovacionMatriculaSociedadBajaActivos.class, selectConsultaPor, idMatricula, idNuevosActivos, idNuevosActivosDos,
