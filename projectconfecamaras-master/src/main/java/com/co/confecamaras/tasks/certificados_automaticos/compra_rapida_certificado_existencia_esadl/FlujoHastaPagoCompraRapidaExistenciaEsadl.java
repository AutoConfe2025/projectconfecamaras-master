package com.co.confecamaras.tasks.certificados_automaticos.compra_rapida_certificado_existencia_esadl;
...
@AllArgsConstructor
public class FlujoHastaPagoCompraRapidaExistenciaEsadl implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitUntil.the(BOTON_AÑADIR_QUINTA_CARD_SELECCION, isPresent()).forNoMoreThan(120).seconds(),
                Click.on(BOTON_AÑADIR_QUINTA_CARD_SELECCION),
    ...
    public static FlujoHastaPagoCompraRapidaExistenciaEsadl FlujoRapidoExistenciaEsadl(String Expediente){
        return instrumented(FlujoHastaPagoCompraRapidaExistenciaEsadl.class,Expediente);
    }
}
