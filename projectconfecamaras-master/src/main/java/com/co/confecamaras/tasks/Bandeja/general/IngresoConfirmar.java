...
import static com.co.confecamaras.userinterfaces.Bandejas.control_calidad.Page.BOTON_CONFIRMAR;
...
public class IngresoConfirmar implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                WaitUntil.the(BOTON_CONFIRMAR, isVisible()).forNoMoreThan(30).seconds(),
    ...
    public static IngresoConfirmar confirma(){
        return new IngresoConfirmar();
    }
}
