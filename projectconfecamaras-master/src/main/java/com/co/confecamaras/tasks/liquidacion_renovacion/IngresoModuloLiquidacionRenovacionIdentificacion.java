...
@AllArgsConstructor
public class IngresoModuloLiquidacionRenovacionIdentificacion implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                SelectFromOptions.byVisibleText(identificacion).from(LISTA_OPCIONES_BUSQUEDA),
                ...
                Clear.field(CAMPO_INGRESO_NUEVO_VALOR_IDENTIFICACION),
                Enter.theValue(NUEVO_VALOR).into(CAMPO_INGRESO_NUEVO_VALOR_IDENTIFICACION),
    ...
    public static IngresoModuloLiquidacionRenovacionIdentificacion ingresoIdentificacion(String identificacion){
        return instrumented(IngresoModuloLiquidacionRenovacionIdentificacion.class, identificacion);
    }
}
