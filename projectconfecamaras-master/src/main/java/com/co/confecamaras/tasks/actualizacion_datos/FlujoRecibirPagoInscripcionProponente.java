...
public class FlujoRecibirPagoInscripcionProponente implements Task {
    @Override
    ...
    public static FlujoRecibirPagoInscripcionProponente FlujoPagoInscripcionProponente(){
        return instrumented(FlujoRecibirPagoInscripcionProponente.class);
    }
}
