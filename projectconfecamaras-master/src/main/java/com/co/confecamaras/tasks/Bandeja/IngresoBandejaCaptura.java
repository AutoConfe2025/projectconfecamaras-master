...
@AllArgsConstructor
public class IngresoBandejaCaptura implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                QueryGeneralBaseDatos.cambiarEstado(CodigoBarrasCapturado, estadoFinal),
                Enter.theValue(CodigoBarrasCapturado).into(CAMPO_BUSQUEDA_COD_BARRAS_INICIAL_1),
                PressKey.press(TypeKey.TAB)
        );
    }

    public static IngresoBandejaCaptura ingresoCaptura(String estadoFinal, String bandeja){
        return instrumented(IngresoBandejaCaptura.class, estadoFinal, bandeja);
    }
}
