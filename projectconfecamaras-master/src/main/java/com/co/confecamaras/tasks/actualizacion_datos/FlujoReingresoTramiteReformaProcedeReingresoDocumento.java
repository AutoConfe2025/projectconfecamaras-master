...
public class FlujoReingresoTramiteReformaProcedeReingresoDocumento implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(BOTON_CONSULTA_MATRICULA_INSCRIPCION, isPresent()).forNoMoreThan(120).seconds(),
                ...
                WaitUntil.the(BOTON_INSCRIPCIONES_DE_DOCUMENTOS, isPresent()).forNoMoreThan(120).seconds(),
                ...
                WaitUntil.the(BOTON_REFORMAS_CAPITAL, isPresent()).forNoMoreThan(120).seconds(),
                Click.on(BOTON_REFORMAS_CAPITAL),
                WaitUntil.the(BOTON_CONTINUAR_AUMENTO_DE_CAPITAL_SUSCRITO_PRIMA, isPresent()).forNoMoreThan(120).seconds(),
                Click.on(BOTON_CONTINUAR_AUMENTO_DE_CAPITAL_SUSCRITO_PRIMA),
                WaitUntil.the(CAMPO_FECHA_DOCUMENTO, isPresent()).forNoMoreThan(120).seconds(),
                Scroll.to(CAMPO_FECHA_DOCUMENTO).andAlignToTop(),
                IngresarFechaActual.enElCampo(CAMPO_FECHA_DOCUMENTO),
                WaitUntil.the(CAMPO_INGRESO_TEXTO_OBSERVACIONES, isPresent()).forNoMoreThan(120).seconds(),
                ...
                Scroll.to(BOTON_CONTINUAR_ESCANEO_DIGITALIZACION).andAlignToTop(),
                Click.on(BOTON_CONTINUAR_ESCANEO_DIGITALIZACION),
                WaitUntil.the(BOTON_CARGA_SOPORTE, isPresent()).forNoMoreThan(120).seconds(),
        ...
        actor.attemptsTo(
                WaitInterrupted2Segundos.esperaConstante2(),
                WaitUntil.the(CAMPO_INGRESO_PDF, isPresent()).forNoMoreThan(120).seconds(),
                ...
                WaitInterrupted2Segundos.esperaConstante2(),
                WaitUntil.the(BOTON_RECIBIR_PAGO_DOCUMENTO, isPresent()).forNoMoreThan(120).seconds(),
