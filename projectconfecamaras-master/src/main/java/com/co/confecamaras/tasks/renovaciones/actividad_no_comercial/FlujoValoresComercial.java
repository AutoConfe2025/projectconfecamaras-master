...
public class FlujoValoresComercial implements Task {
    @Override
    ...
    public static FlujoValoresComercial ValorComercialEstablecimiento(){
        return instrumented(FlujoValoresComercial.class);
    }
}
