...
public class RenovacionMatriculaPNEstadoInactivo implements Task {
    ...
    public RenovacionMatriculaPNEstadoInactivo(String selectConsultaPor, String idMatricula, String idNuevosActivos,
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Enter.theValue("10000000").into(TXT_NUEVOS_ACTIVOS_SOCIEDAD),
                WaitInteractions.untilAppears(TXT_NUEVOS_ACTIVOS_TRES_SOCIEDAD),
                Enter.theValue("10000000").into(TXT_NUEVOS_ACTIVOS_TRES_SOCIEDAD),
                WaitInteractions.untilAppears(TXT_NUEVOS_ACTIVOS_CINCO_SOCIEDAD),
                Enter.theValue("10000000").into(TXT_NUEVOS_ACTIVOS_CINCO_SOCIEDAD),
                WaitInteractions.untilAppears(TXT_NUEVOS_ACTIVOS_DOS_SOCIEDAD),
                Enter.theValue("10000000").into(TXT_NUEVOS_ACTIVOS_DOS_SOCIEDAD),
                WaitInteractions.untilAppears(TXT_NUEVOS_ACTIVOS_CUATRO_SOCIEDAD),
                Enter.theValue("10000000").into(TXT_NUEVOS_ACTIVOS_CUATRO_SOCIEDAD),
                WaitInteractions.untilAppears(TXT_NUEVOS_ACTIVOS_SEIS_SOCIEDAD),
                Enter.theValue("10000000").into(TXT_NUEVOS_ACTIVOS_SEIS_SOCIEDAD),
    ...
    public static RenovacionMatriculaPNEstadoInactivo enConfecamarasSII(String selectConsultaPor, String idMatricula, String idNuevosActivos,
                                                                        String idNuevosActivosDos, String idNuevosActivosTres,
                                                                        String idNuevosActivosCuatro, String idNuevosActivosCinco,
                                                                        String idNuevosActivosSeis, String idNroEmpleados) {
        return instrumented(RenovacionMatriculaPNEstadoInactivo.class, selectConsultaPor, idMatricula, idNuevosActivos, idNuevosActivosDos,
