...
public class DesbloquearLiquidacionPagoElectronico implements Task {

    private String idNumeroRecuperacion;

    public DesbloquearLiquidacionPagoElectronico(String idNumeroRecuperacion) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitInteractions.untilBeEnable(BTN_REGISTROS_PUBLICOS_PROCESOS_ESPECIALES),
                ...
                WaitInteractions.untilAppears(BTN_DESBLOQUEAR_LIQUIDACION_PAGO_ELECTRONICO),
                Scroll.to(BTN_DESBLOQUEAR_LIQUIDACION_PAGO_ELECTRONICO).andAlignToBottom(),
                JavaScriptClick.on(BTN_DESBLOQUEAR_LIQUIDACION_PAGO_ELECTRONICO),
    ...
    public static DesbloquearLiquidacionPagoElectronico enConfecamaraSII(String idNumeroRecuperacion) {
        return instrumented(DesbloquearLiquidacionPagoElectronico.class, idNumeroRecuperacion);
    }
}