...
public class RelacionDeNitsAsignadosTask implements Task {
    ...
    public static RelacionDeNitsAsignadosTask estadisticasYextracciones() {
        return new RelacionDeNitsAsignadosTask();
    }
}