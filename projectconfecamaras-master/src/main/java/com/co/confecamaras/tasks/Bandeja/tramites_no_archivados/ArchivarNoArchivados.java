package com.co.confecamaras.tasks.Bandeja.tramites_no_archivados;
...
import static com.co.confecamaras.utils.estudio_general.constant.ADVERTENCIA_ARCHIVAR_NO_ARCHIVADOS;
...
@AllArgsConstructor
public class ArchivarNoArchivados implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.should(
                seeThat("Mensaje advertencia archivar",
                        of(MENSAJE_ADVERTENCIA_ARCHIVAR_PROCESO), containsString(ADVERTENCIA_ARCHIVAR_NO_ARCHIVADOS))
        );
    ...
    public static ArchivarNoArchivados archivarProceso(String codigo_barras, String estado) {
        return new ArchivarNoArchivados(codigo_barras, estado);
    }
}
