...
import static com.co.confecamaras.userinterfaces.renovaciones.FlujoActualizarProponentePage.BOTON_CONTINUAR_RECIBO_PAGO;
...
public class FlujoRecibirPagoDuplicado implements Task {
    @Override
    ...
    public static FlujoRecibirPagoDuplicado flujoRecibePagoDuplicado(){
        return instrumented(FlujoRecibirPagoDuplicado.class);
    }
}
