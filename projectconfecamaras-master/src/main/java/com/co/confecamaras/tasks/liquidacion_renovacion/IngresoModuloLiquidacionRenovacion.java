...
import static com.co.confecamaras.userinterfaces.liquidacion_renovacion.TablaServiciosUI.FILAS_TABLA;
...
@AllArgsConstructor
public class IngresoModuloLiquidacionRenovacion implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                SelectFromOptions.byVisibleText(nombre).from(LISTA_OPCIONES_BUSQUEDA),
                Enter.theValue(NOMBRE_PARA_BUSQUEDA).into(CAMPO_INGRESO_TEXTO_BUSQUEDA),
                ...
                Click.on(CAMPO_INGRESO_NUEVO_VALOR),
                Clear.field(CAMPO_INGRESO_NUEVO_VALOR),
                Enter.theValue(NUEVO_VALOR).into(CAMPO_INGRESO_NUEVO_VALOR),
    ...
    public static IngresoModuloLiquidacionRenovacion moduloRenovacion(String nombre) {
        return instrumented(IngresoModuloLiquidacionRenovacion.class, nombre);
    }
}
