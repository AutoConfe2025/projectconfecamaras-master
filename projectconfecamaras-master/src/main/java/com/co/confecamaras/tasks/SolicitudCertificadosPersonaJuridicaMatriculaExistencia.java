...
public class SolicitudCertificadosPersonaJuridicaMatriculaExistencia implements Task {

    private String selectConsultaPor;
    private String idMatricula;
    private String idCertificadosMatricula;
    ...
    public SolicitudCertificadosPersonaJuridicaMatriculaExistencia(String selectConsultaPor, String idMatricula, String idCertificadosMatricula,
                                                                   String idCertificadosExistencia, String selectTipoIdentificacion, String idNumeroIdentificacion,
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitInteractions.untilAppears(BTN_SOLICITAR_CERTIFICADOS),
                ...
                ModalLoader.modalLoader(),
                Clear.field(TXT_CERTIFICADOS_MATRICULA_SOLICITUD_CERTIFICADOS),
                Enter.theValue(idCertificadosMatricula).into(TXT_CERTIFICADOS_MATRICULA_SOLICITUD_CERTIFICADOS),
                ...
                JavaScriptClick.on(BTN_DESCARGAR_RECIBO_CAJA_CAPTURAR_EVIDENCIA),
                RobotCambioPestana1.toTab(),
                Scroll.to(BTN_DESCARGAR_CERTIFICADO_CODIGO_CAPTURAR_EVIDENCIA).andAlignToBottom(),
                Click.on(BTN_DESCARGAR_CERTIFICADO_CODIGO_CAPTURAR_EVIDENCIA),
                RobotCambioPestana1.toTab(),
                Click.on(BTN_DESCARGAR_CERTIFICADO_CODIGO_DOS_CAPTURAR_EVIDENCIA),
                RobotCambioPestana1.toTab(),
                ...
                WaitInteractions.untilAppears(BTN_DESCARGAR_CERTIFICADO_DOS_SOLICITUD_CERTIFICADOS),
                Click.on(BTN_DESCARGAR_CERTIFICADO_DOS_SOLICITUD_CERTIFICADOS),
                RobotCambioPestanaDos.toTab(),
    ...
    public static SolicitudCertificadosPersonaJuridicaMatriculaExistencia enConfecamaraSII(String selectConsultaPor, String idMatricula, String idCertificadosMatricula,
                                                                                           String idCertificadosExistencia, String selectTipoIdentificacion, String idNumeroIdentificacion,
                                                                                           String idEmailConfirmacion){
        return instrumented(SolicitudCertificadosPersonaJuridicaMatriculaExistencia.class, selectConsultaPor, idMatricula,
                idCertificadosMatricula, idCertificadosExistencia, selectTipoIdentificacion, idNumeroIdentificacion, idEmailConfirmacion);
    }
}