...
public class RelacionDeDesistimientosTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                LogEvent.recordevent(Reportes.PASSED, "Finalizo correctamnete Relacion De Desistimientos")
        );
    ...
    public static RelacionDeDesistimientosTask estadisticasYextracciones() {
        return new RelacionDeDesistimientosTask();
    }
}