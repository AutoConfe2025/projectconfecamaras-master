...
import com.co.confecamaras.database.QueryConfecamarasRenovacionEsadlOrgDoce;
...
public class RunDataBaseQueryRenovacionEsadlOrgDoce implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {

        QueryConfecamarasRenovacionEsadlOrgDoce queryDatabase = new QueryConfecamarasRenovacionEsadlOrgDoce();
        ...
        DataBase.setNumeroMatriculaEsadlOrgDoce(numMatricula);
    }

    public static RunDataBaseQueryRenovacionEsadlOrgDoce query() {
        return instrumented(RunDataBaseQueryRenovacionEsadlOrgDoce.class);
    }
}