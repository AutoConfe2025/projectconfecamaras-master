package com.co.confecamaras.tasks.certificados_automaticos.certificad_automatico_matricula_libros;
...
@AllArgsConstructor
public class FlujoCertificadoAutomaticoMatriculaLibrosCaja implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        if (BOTON_MATRICULA.isVisibleFor(actor)) {
            actor.attemptsTo(
                    ...
                    WaitUntil.the(CAMPO_INGRESO_CANTIDAD_CERTIFICADOS_MATRICULA, isPresent()).forNoMoreThan(10).seconds(),
                    ...
                    WaitUntil.the(CAMPO_INGRESO_CANTIDAD_CERTIFICADOS_LIBROS, isPresent()).forNoMoreThan(10).seconds(),
                    Click.on(CAMPO_INGRESO_CANTIDAD_CERTIFICADOS_LIBROS),
                    Enter.theValue("1").into(CAMPO_INGRESO_CANTIDAD_CERTIFICADOS_LIBROS),
    ...
    public static FlujoCertificadoAutomaticoMatriculaLibrosCaja CertiMatriculaLibros(String Expediente) {
        return instrumented(FlujoCertificadoAutomaticoMatriculaLibrosCaja.class, Expediente);
    }
}
