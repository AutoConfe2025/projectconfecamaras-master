...
public class CoCertificadoOcSucursalUsPu {
    ...
    public static Target BTN_CONSULTAR_SUCURSAL = Target.the("Boton consultar Matricula").
    ...
    public static Target TXT_CERTIFICADO_SUCURSAL = Target.the("cuadro de texto Certificados de Existencia Esadl (Min.1):").
            located(By.id("certimat"));
    public static Target BTN_CONTINUAR_SOLICITUD_CERTIFIACDO_SUCURSAL = Target.the("Boton continuar ventana  Solicitud de certificados").
            located(By.id("generarLiquidacion"));
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_SUCURSAL = Target.the("Mensaje de validacion de finalizacion de flujo").
