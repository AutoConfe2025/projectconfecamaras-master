...
public class CoCertificadoCaEsadlUsPu {
    ...
    public static Target BTN_ACCIONES_ESADL = Target.the("Boton acciones en Consulta de expedientes").
            located(By.cssSelector(".btn.btn-sm.btn-outline-info.offset-1"));
    public static Target BTN_OPCION_MERCANTIL_ESADL = Target.the("Boton Opcion mecantil ESADL").
    ...
    public static Target TXT_CERTIFICADO_LIBROS = Target.the("Cuadro de texto certificados de libros").
            located(By.id("certilib"));
