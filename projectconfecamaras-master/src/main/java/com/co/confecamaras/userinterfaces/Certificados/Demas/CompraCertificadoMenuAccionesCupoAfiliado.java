...
public class CompraCertificadoMenuAccionesCupoAfiliado {
    ...
    public static Target VALIDACION_CERTIFICADO_GENERADO = Target.the("Validacion de la ventana del certificado").
            located(By.xpath("(//h2[normalize-space()='Certificado generado'])[1]"));
    public static Target BTN_DESCARGAR = Target.the("").
            located(By.xpath("//th[@scope='row']//a[@class='btn btn-outline-primary btn-sm']"));
    public static Target BTN_CONTINUAR = Target.the("").
