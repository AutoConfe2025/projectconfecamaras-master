...
public class CoCertificadoCdEstUsPu {
    ...
    public static Target BTN_OPERACION_REG_MERCANTIL_ESADL = Target.the("Boton Operaciones del registro mercantil / ESADL").
            located(By.xpath("//*[@id=\"consultaDetalladaExpediente\"]/div/div/div[2]/div/div[11]/div/div[1]/div/span[1]/div/div"));
    public static Target BTN_SOLICITUD_CERTIFICADOS = Target.the("Boton Solicitud de Certificados").
            located(By.xpath("/html/body/div[1]/div[4]/div/div/form/div/div/div[2]/div/div[11]/div/div[2]/div[1]/div/div[2]/div/div[2]/table/tbody/tr/td[2]/a"));
    ...
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_CONSULTA_DETALLADA_ESTABLECIMIENTO = Target.the("Mensaje de validacion de finalizacion de flujo").
