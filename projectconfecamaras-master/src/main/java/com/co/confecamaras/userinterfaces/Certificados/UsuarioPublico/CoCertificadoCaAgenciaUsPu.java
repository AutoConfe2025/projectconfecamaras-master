...
public class CoCertificadoCaAgenciaUsPu {
    ...
    public static Target BTN_ACCIONES_AGENCIA = Target.the("Boton acciones en Consulta de expedientes").
            located(By.cssSelector(".btn.btn-sm.btn-outline-info.offset-1"));
    public static Target BTN_OPCION_MERCANTIL_AGENCIA = Target.the("Boton Opcion mecantil AGENCIA").
            located(By.xpath("//*[@id=\"modalAuxiliar\"]/div/div/div[2]/div[1]/div[2]/div/div[1]"));
    public static Target BTN_SOLICITAR_CERTIFICADO = Target.the("Boton solicitar certificado en acciones del expediente").
    ...
    public static Target BTN_CONTINUAR_SOLICITUD_CERTIFICADO_SUCURSAL = Target.the("Boton continuar solucitud certificado").
            located(By.id("generarLiquidacion"));
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_CONSULTA_DETALLADA_SUCURSAL = Target.the("Mensaje de validacion de finalizacion de flujo").
