...
public class CoCertificadoOcEsadlUsPu {
    ...
    public static Target BTN_CONSULTAR = Target.the("Boton consultar Matricula").
    ...
    public static Target TXT_CERTIFICADO_ESADL = Target.the("cuadro de texto Certificados de Existencia Esadl (Min.1):").
    ...
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_ESADL = Target.the("Mensaje de validacion de finalizacion de flujo").
