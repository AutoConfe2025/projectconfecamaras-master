...
public class CompraRapidaCertificadosPagoNoPresencial extends PageObject {
    ...
    public static Target BOTON_COMPRAR = Target.the("Dar clic en el boton con el icono del carrito de compras").
    ...
    public static Target VERIFICACION_QUE_AÑADIO = Target.the("Verificacion que si se añadio en el carrico de compras un certificado").
            located(By.xpath("(//button[@class='sc-add-to-cart btn btn-success btn-sm pull-right mt-2 '])[1]"));

    public static Target BOTON_PAGAR = Target.the("Dar clic en el boton pagar").
            located(By.xpath("(//button[normalize-space()='Pagar'])[1]"));
