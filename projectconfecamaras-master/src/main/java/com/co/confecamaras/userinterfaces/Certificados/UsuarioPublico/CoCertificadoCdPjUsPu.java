...
public class CoCertificadoCdPjUsPu {
    ...
    public static Target BTN_OPERACION_REG_MERCANTIL_PJ = Target.the("Boton Operaciones del registro mercantil / ESADL").
            located(By.xpath("//div[16]//div[1]//div[1]//div[1]//span[1]//div[1]//div[1]//h6[1]"));
    ...
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_CONSULTA_DETALLADA_PERSONA_JURIDICA = Target.the("Mensaje de validacion de finalizacion de flujo").
