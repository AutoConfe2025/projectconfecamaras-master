...
public class CoCertificadoCaPnUsPu {
    ...
    public static Target BTN_ACCIONES_PN = Target.the("Boton acciones en Consulta de expedientes").
            located(By.cssSelector(".btn.btn-sm.btn-outline-info.offset-1"));
    public static Target BTN_OPCION_MERCANTIL_PN = Target.the("Boton Opcion mecantil ESADL").
    ...
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_CONSULTA_DETALLADA_PN = Target.the("Mensaje de validacion de finalizacion de flujo").
