...
public class CoCertificadoCaEstUsPu {
    ...
    public static Target BTN_ACCIONES_EST = Target.the("Boton acciones en Consulta de expedientes").
            located(By.cssSelector(".btn.btn-sm.btn-outline-info.offset-1"));
    public static Target BTN_OPCION_MERCANTIL_EST = Target.the("Boton Opcion mecantil ESADL").
    ...
    public static Target MENSAJE_VALIDACION_SOPORTE_DE_TRANSACCION_CONSULTA_DETALLADA_EST = Target.the("Mensaje de validacion de finalizacion de flujo").
