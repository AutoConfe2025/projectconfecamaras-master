...
public class CompraRapidaCertificadosCc extends PageObject {
    ...
    public static Target BTN_MI_CARRITO = Target.the("Boton mi carrito").
            located(By.cssSelector(".btn.btn-outline-primary.btn-sm"));
    public static Target BTN_PAGAR = Target.the("Boton pagar").
            located(By.cssSelector("button[class='btn btn-info sc-cart-checkout mt-1']"));
    public static Target TXT_CORREO = Target.the("Cuadro de texto de correo").
            located(By.cssSelector("input[placeholder='Correo electrónico']"));
    public static Target BTN_OK = Target.the("Boton ok Por favor digite su correo electrónico:").
