...
public class RevisaMatriculaPersonaNaturalEstablecimiento implements Question<Boolean> {
    @Override
    ...
    public static RevisaMatriculaPersonaNaturalEstablecimiento enConfecamaraSII(){
        return new RevisaMatriculaPersonaNaturalEstablecimiento();
    }
}