...
public class CertificadoESADLExistenciaQuestion implements Question {
    @Override
    ...
    public static CertificadoESADLExistenciaQuestion validacion(){
        return new CertificadoESADLExistenciaQuestion();
    }
}
