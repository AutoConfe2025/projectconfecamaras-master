...
import static com.co.confecamaras.userinterfaces.registros_publicos.ExtraccionLibrosActosPage.MENSAJE_GENERACION_REPORTE_EE;
...
public class ValidaRegistrosPublicos {
    ...
    public static Question<Boolean> registroReporteEE() {
        return Visibility.of(MENSAJE_GENERACION_REPORTE_EE);
    }
}
