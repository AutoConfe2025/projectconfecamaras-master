...
public class RevisaRenovacionEsadlOrgCatorce implements Question<Boolean> {
    @Override
    public Boolean answeredBy(Actor actor) {
        return LBL_MENSAJE_FINAL_RENOVACION_MATRICULA_SOCIEDAD.resolveFor(actor).isVisible();
    }

    public static RevisaRenovacionEsadlOrgCatorce enConfecamarasSii(){
        return new RevisaRenovacionEsadlOrgCatorce();
    }
}