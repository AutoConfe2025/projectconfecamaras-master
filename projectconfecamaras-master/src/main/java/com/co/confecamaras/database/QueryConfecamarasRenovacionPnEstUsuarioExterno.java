...
public class QueryConfecamarasRenovacionPnEstUsuarioExterno {
    ...
    public Map<String, Object> buscarData() throws SQLException {
        ...
        while (rsDoc.next()) {
            ...
            //System.out.println("NUMERO DOCUMENTO: " + columnCount);
            ...
            System.out.println("NUMERO MATRICULA: " + rowData);
        }
        getCon().close();
        return valueMapDoc;
    }
