...
public class QueryCompraVentasCambiarEstadoCodBarras implements Task {
    private final String codigo_barras;

    public QueryCompraVentasCambiarEstadoCodBarras(String codigo_barras) {
    ...
    public static QueryCompraVentasCambiarEstadoCodBarras cambiarEstado(String codigo_barras) {
        return new QueryCompraVentasCambiarEstadoCodBarras(codigo_barras);
    }
}
