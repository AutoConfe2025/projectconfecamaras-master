...
public class QueryDigitacionRegMtilCambiarEstadoCodBarras implements Task {
    private final String codigo_barras;

    public QueryDigitacionRegMtilCambiarEstadoCodBarras(String codigo_barras) {
    ...
    public static QueryDigitacionRegMtilCambiarEstadoCodBarras cambiarEstado(String codigo_barras) {
        return new QueryDigitacionRegMtilCambiarEstadoCodBarras(codigo_barras);
    }
}
