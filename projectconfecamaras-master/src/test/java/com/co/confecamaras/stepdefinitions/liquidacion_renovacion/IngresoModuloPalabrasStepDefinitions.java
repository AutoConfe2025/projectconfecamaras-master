...
import com.co.confecamaras.tasks.liquidacion_renovacion.IngresoModuloLiquidacionRenovacionPalabras;
...
public class IngresoModuloPalabrasStepDefinitions {

    @When("realizo el proceso con {string}")
    public void realizoElIngresoAlModuloPorNombre(String palabras) {
        theActorInTheSpotlight().attemptsTo(IngresoModuloLiquidacionRenovacionPalabras.porPalabras(palabras));
    }

    @Then("valido el proceso de matricula por palabras")
    public void validoElProcesoDeMatricula() {
        ...
        validaServicioYValor(tabla, "01020202", "$ 116.000");
