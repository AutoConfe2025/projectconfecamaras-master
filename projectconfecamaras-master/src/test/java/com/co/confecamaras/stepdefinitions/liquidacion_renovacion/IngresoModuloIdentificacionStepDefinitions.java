...
import com.co.confecamaras.tasks.liquidacion_renovacion.IngresoModuloLiquidacionRenovacionIdentificacion;
...
public class IngresoModuloIdentificacionStepDefinitions {
    @When("realizo el proceso por {string}")
    public void realizoElIngresoAlModuloPorNombre(String Identicación) {
        theActorInTheSpotlight().attemptsTo(IngresoModuloLiquidacionRenovacionIdentificacion.ingresoIdentificacion(Identicación));
    }

    @Then("valido el proceso de matricula por identificacion")
    public void validoElProcesoDeMatricula() {
        ...
        validaServicioYValor(tabla, "01020208", "$ 465.000");
        validaServicioYValor(tabla, "01010301", "$ 11.600");
