...
public class TramitesDevueltosStepDefinitions {
    ...
    public void validaraLasAccionesDeTramitesDevueltosRelacionadosAlCodigoDeBarras(String codigo_barras, String estado) {
        OnStage.theActorInTheSpotlight().attemptsTo(TramitesDevueltosTask.devueltos(codigo_barras,estado));
    }
