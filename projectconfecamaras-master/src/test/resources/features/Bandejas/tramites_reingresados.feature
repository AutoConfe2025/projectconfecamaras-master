...
Característica: valida de bandeja de tramites reingresados
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoPDF
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoValidaComentarios
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoAgregarComentario
