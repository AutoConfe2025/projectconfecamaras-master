...
Característica: valida de bandeja de tramites reingresados
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoPDF @Bandejas @SII4
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoAgregarComentario @Bandejas @SII4
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoValidaComentarios @Bandejas @SII4
  ...
  @ValidacionBandejaTramitesReingresadosEnProcesoEscanear @Bandejas @SII4
  Escenario: ingreso a la bandeja Tramites reingresados en proceso escanear
    Y ingreso al sistema SII3 como usuario publico
    Cuando ingreso a la bandeja con captura "09" "Tramites reingresados (En reparto)"
    Entonces realizo el proceso de escanear

  @ValidacionBandejaTramitesReingresadosEnProcesoFinalizar @Bandejas @SII4
  Escenario: ingreso a la bandeja Tramites reingresados en proceso escanear
    Y ingreso al sistema SII3 como usuario publico
    Cuando ingreso a la bandeja con captura "09" "Tramites reingresados (En reparto)"
