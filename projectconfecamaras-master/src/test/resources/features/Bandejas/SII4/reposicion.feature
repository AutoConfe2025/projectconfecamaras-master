...
Característica: validacion de bandeja recursos de reposicion
  ...
  @ValidacionBandejaRecurosDeReposicionPDF @Bandejas @SII4
  ...
  @ValidacionBandejaRecurosDeReposicionComentarios @Bandejas @SII4
  ...
  @ValidacionBandejaRecurosDeReposicionIngresoComentarios @Bandejas @SII4
  Escenario: ingreso a la bandeja recursos de reposicion y ingreso un comentario
    Y ingreso al sistema SII3 como usuario publico
    Cuando ingreso a la bandeja recursos "745929" "04"
    Entonces ingreso un nuevo comentario

  @ValidacionBandejaRecurosDeReposicionResponder @Bandejas @SII4
  ...
  @ValidacionBandejaRecurosDeReposicionArchivar @Bandejas @SII4
