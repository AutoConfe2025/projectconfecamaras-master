...
Característica: validacion de bandeja revision de desistimientos
  ...
  @ValidacionBandejaRevisionDesistimientosPDF @Bandejas @SII4
  ...
  @ValidacionBandejaRevisionDesistimientosConfirmacionTelefonica @Bandejas @SII4
  Escenario: ingreso a la bandeja revision de desistimientos agrego comentario
    Y ingreso al sistema SII3 como usuario publico
    Cuando Cuando ingreso a la bandeja "14259614" "39" "Revision Desistimientos"
    Entonces realizo la confirmacion telefonica

  @ValidacionBandejaRevisionDesistimientosNotificadoPresencial @Bandejas @SII4
  ...
  @ValidacionBandejaRevisionDesistimientosArchivar @Bandejas @SII4
