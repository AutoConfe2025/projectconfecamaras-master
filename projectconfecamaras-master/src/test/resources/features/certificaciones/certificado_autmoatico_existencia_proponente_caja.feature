...
Característica: flujo de certificados certificado automatico existencia proponente caja

  Antecedentes: ingreso plataforma confecamaras
    Dado Confecamaras ingresa al sistema de confecamaras

  @FlujoCertificadoAutomaticoExistenciaProponenteCaja @Certificaciones @SII4
